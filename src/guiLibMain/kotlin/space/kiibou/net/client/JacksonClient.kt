...
class JacksonClient(
    ...
    private val onMessageReceived: (JsonNode) -> Unit,
    private val onDisconnect: () -> Unit
) {
    private var socket: Socket? = null
    private var connection: SocketConnection? = null

    fun connect(address: String, port: Int): JacksonClient {
        try {
    ...
    fun send(obj: JsonNode) {
        sendString(mapper.writeValueAsString(obj))
    }
